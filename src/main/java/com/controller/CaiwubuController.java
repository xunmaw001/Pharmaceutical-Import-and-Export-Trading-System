...
public class CaiwubuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CaiwubuEntity user = caiwubuService.selectOne(new EntityWrapper<CaiwubuEntity>().eq("yuangonggonghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"caiwubu",  "财务部" );
    ...
    public R register(@RequestBody CaiwubuEntity caiwubu){
    	...
    	CaiwubuEntity user = caiwubuService.selectOne(new EntityWrapper<CaiwubuEntity>().eq("yuangonggonghao", caiwubu.getYuangonggonghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        CaiwubuEntity user = caiwubuService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        caiwubuService.updateById(user);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<CaiwubuEntity> wrapper = new EntityWrapper<CaiwubuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = caiwubuService.selectCount(wrapper);
