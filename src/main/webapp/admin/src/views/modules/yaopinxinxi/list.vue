<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yaopinxinxi','过期') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="guoqiyaopinCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'过期':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','过期') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="guoqiyaopinCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'过期':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','过期') && contents.tableBtnIcon == 0" type="success" size="mini" @click="guoqiyaopinCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'过期':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','采购') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="caigoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'采购':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','采购') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="caigoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'采购':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','采购') && contents.tableBtnIcon == 0" type="success" size="mini" @click="caigoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'采购':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','销售') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="xiaoshoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'销售':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','销售') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="xiaoshoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'销售':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','销售') && contents.tableBtnIcon == 0" type="success" size="mini" @click="xiaoshoudingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'销售':'' }}</el-button>
    ...
    <guoqiyaopin-cross-add-or-update v-if="guoqiyaopinCrossAddOrUpdateFlag" :parent="this" ref="guoqiyaopinCrossaddOrUpdate"></guoqiyaopin-cross-add-or-update>
    <caigoudingdan-cross-add-or-update v-if="caigoudingdanCrossAddOrUpdateFlag" :parent="this" ref="caigoudingdanCrossaddOrUpdate"></caigoudingdan-cross-add-or-update>
...
import guoqiyaopinCrossAddOrUpdate from "../guoqiyaopin/add-or-update";
import caigoudingdanCrossAddOrUpdate from "../caigoudingdan/add-or-update";
...
export default {
  data() {
    return {
      ...
      guoqiyaopinCrossAddOrUpdateFlag: false,
      caigoudingdanCrossAddOrUpdateFlag: false,
  ...
  components: {
    ...
    guoqiyaopinCrossAddOrUpdate,
    caigoudingdanCrossAddOrUpdate,
  ...
  methods: {
    ...
    guoqiyaopinCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.guoqiyaopinCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yaopinxinxi');
      this.$storage.set('statusColumnName',statusColumnName);
      this.$storage.set('statusColumnValue',statusColumnValue);
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.guoqiyaopinCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.guoqiyaopinCrossaddOrUpdate.init(row.id,type);
      });
    },
    caigoudingdanCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.caigoudingdanCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yaopinxinxi');
      this.$storage.set('statusColumnName',statusColumnName);
      this.$storage.set('statusColumnValue',statusColumnValue);
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.caigoudingdanCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.caigoudingdanCrossaddOrUpdate.init(row.id,type);
      });
    },
