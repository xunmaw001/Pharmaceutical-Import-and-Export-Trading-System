<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报号" prop="baohao">
          <el-input v-model="ruleForm.baohao" 
              placeholder="报号" clearable  :readonly="ro.baohao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报号" prop="baohao">
              <el-input v-model="ruleForm.baohao" 
                placeholder="报号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品进价" prop="yaopinjinjia">
          <el-input v-model="ruleForm.yaopinjinjia" 
              placeholder="药品进价" clearable  :readonly="ro.yaopinjinjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品进价" prop="yaopinjinjia">
              <el-input v-model="ruleForm.yaopinjinjia" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinshuliang = true;
          ...
          if(o=='yaopinjinjia'){
            this.ruleForm.yaopinjinjia = obj[o];
	    this.ro.yaopinjinjia = true;
            continue;
          }
          if(o=='yaopinshoujia'){
