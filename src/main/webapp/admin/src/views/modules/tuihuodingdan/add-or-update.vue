<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退货数量" prop="tuihuoshuliang">
          <el-input v-model="ruleForm.tuihuoshuliang" 
              placeholder="退货数量" clearable  :readonly="ro.tuihuoshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退货数量" prop="tuihuoshuliang">
              <el-input v-model="ruleForm.tuihuoshuliang" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退款金额" prop="tuikuanjine">
            <el-input v-model="tuikuanjine"
                placeholder="退款金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuikuanjine" label="退款金额" prop="tuikuanjine">
              <el-input v-model="ruleForm.tuikuanjine" 
                placeholder="退款金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客户电话" prop="kehudianhua">
          <el-input v-model="ruleForm.kehudianhua" 
              placeholder="客户电话" clearable  :readonly="ro.kehudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客户电话" prop="kehudianhua">
              <el-input v-model="ruleForm.kehudianhua" 
                placeholder="客户电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="退货原因" prop="tuihuoyuanyin">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuihuoyuanyin" label="退货原因" prop="tuihuoyuanyin">
                    <span v-html="ruleForm.tuihuoyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    tuikuanjine:{
      get: function () {
        return 1*this.ruleForm.tuihuoshuliang*this.ruleForm.yaopinshoujia
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chandi = true;
          ...
          if(o=='tuihuoshuliang'){
            this.ruleForm.tuihuoshuliang = obj[o];
	    this.ro.tuihuoshuliang = true;
            continue;
          }
          if(o=='yaopinshoujia'){
	    ...
	    this.ro.yaopinshoujia = true;
          ...
          if(o=='tuikuanjine'){
            this.ruleForm.tuikuanjine = obj[o];
	    this.ro.tuikuanjine = true;
            continue;
          }
          if(o=='kehumingcheng'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.kehumingcheng!=''&&json.kehumingcheng){
                this.ruleForm.kehumingcheng = json.kehumingcheng
	    		this.ro.kehumingcheng = true;
		}
		if(json.kehudianhua!=''&&json.kehudianhua){
                this.ruleForm.kehudianhua = json.kehudianhua
	    		this.ro.kehudianhua = true;
		}
		if(json.kehudizhi!=''&&json.kehudizhi){
                this.ruleForm.kehudizhi = json.kehudizhi
	    		this.ro.kehudizhi = true;
		}
        } else {
	...
	this.ruleForm.tuihuoyuanyin = this.ruleForm.tuihuoyuanyin.replace(reg,'../../../ssm7049m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
        this.ruleForm.tuikuanjine = this.tuikuanjine
