    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          yaopinzhengshiming: row.yaopinzhengshiming,
          guige: row.guige,
          danwei: row.danwei,
          chandi: row.chandi,
          tuihuoshuliang: row.tuihuoshuliang,
          yaopinshoujia: row.yaopinshoujia,
          tuikuanjine: row.tuikuanjine,
          kehumingcheng: row.kehumingcheng,
          kehudianhua: row.kehudianhua,
          kehudizhi: row.kehudizhi,
